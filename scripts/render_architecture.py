...
label(95, 209, 'HTTP :80   /   HTTPS :443 (인증서 대기)', 21)
...
label(76, 953, '실측 완료: VCN·서브넷·IGW·라우트·NSG·SSH 제한·IAM·내부/외부 HTTP 200', 21, '#216f63')
label(76, 994, '유지: VM·볼륨·기존 서비스 / 대기: DNS·공개 HTTPS / 원복은 명시적 요청 후', 20, '#806321')
