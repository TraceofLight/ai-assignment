...
1~3 완료. 4는 인위적 503 대신 실제 발생한 capability·CRLF·OCI ingress 오류의 재현/해결로 대체했다. 5는 사용자 DNS 등록 후 발급 제한의 재시도 시각을 기다려 2026-09-27 01:03 KST 공개 HTTPS 검증까지 완료. 6~7 산출물과 외부 HTTP·Docker·IAM·기존 서비스 보존을 검증했다. 원복은 실행하지 않았다.
